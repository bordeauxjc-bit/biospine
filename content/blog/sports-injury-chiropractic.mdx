...
If a concussion is suspected, the athlete should be removed from play and evaluated by a healthcare provider. The [CDC HEADS UP response guide](https://www.cdc.gov/heads-up/response/index.html) explains the warning signs and return-to-sport precautions.
